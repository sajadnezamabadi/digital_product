...
class Gateaway(models.Model):
    title = models.CharField(_('title'),max_length=50)
    description = models.TextField(_('description'),blank=True)
    avatar = models.ImageField(_("avatar"),blank=True,upload_to='gateaways/')
...
class Payment(models.Model):
    ...
    gateaway = models.ForeignKey(Gateaway,verbose_name=_('gateaway'),related_name='%(class)s',on_delete=models.CASCADE)
    ...
    consumed_code = models.PositiveIntegerField(_("consumed reference code"),null=True,db_index=True)#code rahgiri
