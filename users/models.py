...
class UserManager(BaseUserManager):
    ...
    def _create_user(self, username , phone_number , email , password , is_staff , is_superuser , **extra_fields):
        ...
        if not username:
            raise ValueError('The given username must set.')
    ...
    def create_user(self,username =None,phone_number=None,email=None,password=None,**extra_fields):
        if username is None:
            ...
            if phone_number:
                username = random.choice('abcdefgijklmnopqrstuvwxyz')+ str(phone_number)[-7:]
...
class User(AbstractBaseUser,PermissionsMixin):
    """
    an abstract base class impolementing a fully featured User model with
    ...
    frist_name = models.CharField(_("frist name"), max_length=50,blank=True)
    ...
    is_staff = models.BooleanField(_('staff status'),default=False,help_text=_('designates whether that user can log into this admin site.'))
    
    is_active= models.BooleanField(_("active"),default=True,help_text=_('designates whether this user should be treated as active. unselect this instead of deleting account.'))
    ...
    def get_full_name(self):
        """
        Returns the frist name plus the last name with space between.
        """
    ...
    def is_loggedin_user(self):
        """
        Return true if user has actulally logged in with valiid credentials.
        """
