    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frist_name', models.CharField(blank=True, max_length=50, verbose_name='frist name')),
                ...
                ('is_staff', models.BooleanField(default=False, help_text='designates whether that user can log into this admin site.', verbose_name='staff status')),
